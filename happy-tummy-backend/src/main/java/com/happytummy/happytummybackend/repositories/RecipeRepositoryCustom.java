...
public interface RecipeRepositoryCustom {
    ...
    List<Recipe> findByIngredientName(String[] ingredientNames,int limit, int pageIndex);
    List<Recipe> findByCombinedIngredientName(String[] ingredientNames,int limit, int pageIndex);
